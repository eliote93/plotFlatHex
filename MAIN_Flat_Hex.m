...
for iimag = 1:ndat(1, 2)
    PLOT_xy(fid, fn, ndat, l3d, lerr, lrel, istr, igcf, fgca, xylmin, xylmax, xymx, lbrad, XX, YY);
...
if l3d
    ...
    tline = fgetl(fid);
    for iimg = 1:ndat(2, 2)
        PLOT_z(fid, fn, ndat, lerr, lrel, istr, igcf, fgca, zlmin, zlmax, lbax, grdhgt);
    end
    fclose(fid);
end
return